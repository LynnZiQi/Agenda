...
public:
  bool modify_password(std::function<bool(const User &)> filter, const std :: string& new_password);

  void modify_phone(std::function<bool(const User &)> filter, const std :: string& new_password);
  /**
