...
class AgendaService {
   public:
     ...
     */
     bool modify_password(const std :: string& userName, const std :: string& new_password);
     bool modify_phone(const std :: string& userName, const std :: string& new_password);
...
bool find_back(const std :: string &name, const std :: string &phone, const std :: string& email, const std :: string& new_password);
   private:
